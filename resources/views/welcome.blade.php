            ...
            <div id="nav" class="collapse navbar-collapse">
                <div class="d-flex justify-content-between w-100">
                    ...
                    <nav class="navbar-nav  text-center d-flex gap-5 justify-content-end">
                        ...
                        <a href="#section-5">Educación</a>
                        <a href="#section-6">Certificaciones</a>
                    </nav>
                </div>
            </div>
        </div>
    ...
    <div id="menu" class="offcanvas offcanvas-start">
        ...
        <div class="offcanvas-body">
            <nav class="text-center d-flex flex-column">
                ...
                <a class="text-dark text-decoration-none" href="#section-5">
...
<main>
            ...
            <div class="container-xl">
                ...
                <div class="about d-flex flex-column flex-md-row gap-4 ">
                    <div class="d-flex align-items-center justify-content-center">
                        <div class="img-photo text-center">
                            <img class="img-fluid" src="{{ asset('img/photo.jpg') }}" alt="">
                        </div>
                    </div>
                    <div>
                        <h4 class="mb-4 text-center name">José Gudalupe Reséndiz Reséndiz</h4>
                        <p class="text-white info">
                            Tengo conocimientos en procesos de desarrollo de software clásicos y agiles, además en actividades para el aseguramiento de la calidad. Cuento con las aptitudes para trabajar tanto en equipo como de forma personal. He participado en concursos de programación. Además, me considero una persona autodidacta. Por mi cuenta he aprendido sobre base de datos y lenguajes de programación, concluyendo en un sistema de gestión de una tienda o ejemplificando diferentes entornos reales. Con todo esto busco impactar positivamente a la sociedad desarrollando proyectos de software. Tengo la disponibilidad de mudarme al lugar de trabajo, de aprender y adaptarme al trabajo.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <section id="section-2" class="container-xl">
        ...
        <div class="section mb-5 d-flex flex-column flex-md-row">
            <div class="w-100 w-md-50">
                <h3 class="mb-4">Habilidades</h3>
                <div class="d-flex gap-4 mb-2">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#313C4E"><path d="M480-280q83 0 141.5-58.5T680-480q0-83-58.5-141.5T480-680q-83 0-141.5 58.5T280-480q0 83 58.5 141.5T480-280Zm0 200q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm0-320Z"/></svg>
    ...
    <section id="section-3" class="container-xl">
        ...
        <div class="section mb-5">
            ...
            <p class="mb-3">Rafik MX. Enero 2024 - Junio 2024.</p>
            <p class="exp-laboral">
                Rafik es una empresa del ámbito legal donde realicé mis prácticas profesionales. Trabajé como desarrollador web con la tecnología de PHP con Laravel. Mis actividades iban desde el diseño de páginas web hasta la programación de diferentes módulos. Por la parte del Frontend trabajé con JavaScript, JQuery, HTML, CSS, Bootstrap y archivos SASS. Del lado del Backend utilicé PHP con el framework Laravel.
            </p>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="d-flex flex-column gap-3">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <div style="width: 30px">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 48 48" width="30px" height="30px"><path fill="#ff5722" d="M6 6H22V22H6z" transform="rotate(-180 14 14)"/><path fill="#4caf50" d="M26 6H42V22H26z" transform="rotate(-180 34 14)"/><path fill="#ffc107" d="M26 26H42V42H26z" transform="rotate(-180 34 34)"/><path fill="#03a9f4" d="M6 26H22V42H6z" transform="rotate(-180 14 34)"/></svg>
                            </div>
                            Tecnología Microsoft para la productividad, 12 de julio 2017.
                        </div>
                        <div class="d-flex align-items-center gap-2">
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-0.44 0.24 120 60" width="60" height="30"><g transform="matrix(1.199534 0 0 1.199534 15.237208 6.249314)" fill="#0096d6"><path d="M21.4 26.2h3.2v12.5h-3.2zM50 29.8c-.1-.1-1.1-.7-2.7-.7-2 0-3.5 1.4-3.5 3.3s1.4 3.3 3.5 3.3c1.5 0 2.5-.6 2.7-.7v3.4c-.4.1-1.5.4-2.9.4-3.6 0-6.7-2.4-6.7-6.5 0-3.7 2.8-6.5 6.7-6.5 1.5 0 2.6.4 2.9.4zm-33 0c-.1-.1-1.1-.7-2.7-.7-2 0-3.5 1.4-3.5 3.3s1.4 3.3 3.5 3.3c1.5 0 2.5-.6 2.7-.7v3.4c-.4.1-1.5.4-2.9.4-3.5 0-6.7-2.4-6.7-6.5 0-3.7 2.8-6.5 6.7-6.5 1.5 0 2.6.4 2.9.4zm49.5 2.7c0 3.6-2.8 6.5-6.6 6.5s-6.6-2.9-6.6-6.5 2.8-6.5 6.6-6.5c3.9 0 6.6 2.9 6.6 6.5zm-6.6-3.3c-1.9 0-3.3 1.5-3.3 3.3s1.4 3.3 3.3 3.3 3.3-1.5 3.3-3.3-1.4-3.3-3.3-3.3zm-23.4-.1s-1.4-.4-2.5-.4c-1.3 0-2 .4-2 1 0 .8.9 1 1.4 1.2l.9.3c2 .7 3 2.1 3 3.6 0 3.1-2.8 4.2-5.2 4.2-1.7 0-3.3-.3-3.4-.3v-2.9c.3.1 1.6.5 3 .5 1.6 0 2.3-.5 2.3-1.2 0-.6-.6-1-1.4-1.2-.2-.1-.5-.2-.7-.2-1.8-.6-3.2-1.6-3.2-3.7 0-2.3 1.8-3.9 4.7-3.9 1.5 0 3 .4 3.1.4z"/><use xlink:href="#A"/><path d="M12.7 8.5a1.58 1.58 0 0 0-1.6-1.6c-.9 0-1.5.7-1.5 1.6v7.6a1.58 1.58 0 0 0 1.6 1.6 1.58 1.58 0 0 0 1.6-1.6V8.5zm8.7-5.9A1.58 1.58 0 0 0 19.8 1a1.58 1.58 0 0 0-1.6 1.6v16.6a1.58 1.58 0 0 0 1.6 1.6 1.58 1.58 0 0 0 1.6-1.6zM30 8.5a1.58 1.58 0 0 0-1.6-1.6 1.58 1.58 0 0 0-1.6 1.6v7.6a1.58 1.58 0 0 0 1.6 1.6 1.58 1.58 0 0 0 1.6-1.6z"/><use xlink:href="#A" x="34.5"/><path d="M47.2 8.5a1.58 1.58 0 1 0-3.2 0v7.6a1.58 1.58 0 1 0 3.2 0zm8.6-5.9a1.58 1.58 0 1 0-3.2 0v16.6a1.58 1.58 0 1 0 3.2 0zm8.6 5.9a1.58 1.58 0 1 0-3.2 0v7.6a1.58 1.58 0 1 0 3.2 0zm8.6 4.3a1.58 1.58 0 1 0-3.2 0v3.3a1.58 1.58 0 1 0 3.2 0z"/></g><defs><path id="A" d="M4.1 12.8a1.58 1.58 0 0 0-1.6-1.6 1.58 1.58 0 0 0-1.6 1.6v3.3a1.58 1.58 0 0 0 1.6 1.6 1.58 1.58 0 0 0 1.6-1.6z"/></defs></svg>
                            </div>
