...
recolección de firmas digitales y mejora de módulos para mejora la experiencia del usuario. 
    ...
    <section id="section-4" class="container-xl">
        ...
        <div class="section px-0" style="background-color: #313C4E">
                ...
                <div class="contenedor-proyect col-md-6 mb-md-0 mb-4" style="z-index: 70">
                    <div class="proyect">
                        ...
                        <div>
                            ...
                            <div class="proyect-content">
                                <a href="https://resendizj.pythonanywhere.com/" target="_blank">
                                    <div class="proyect-img">
            ...
            <div class="row mb-5 g-5 justify-content-center">
                <div class="contenedor-proyect col-md-6 mb-md-0 mb-4" style="z-index: 60">
                    <div class="proyect">
                        <h5>Emparejamiento de cartas</h5>
                        <p class="proyect-date">Junio - 2024</p>

                        <p class="align-content-center">
                            Videojuego de emparejamiento de cartas.
                        </p>

                        <div>

                            <div class="proyect-content">
                                <a href="https://memorygame.reediz.com/" target="_blank">
                                    <div class="proyect-img">
                                        <div id="indicadores" class="carousel slide"  data-bs-ride="carousel">
                                            ...
                                            <div class="carousel-inner">
                                                <div class="carousel-item active">
                                                    <img class="img-fluid movil-img" src="{{asset('img/memorygame/cards.png')}}" alt="">
                                                </div>
                                                <div class="carousel-item">
                                                    <img class="img-fluid movil-img" src="{{asset('img/memorygame/index.png')}}" alt="">
                                                </div>
                                                <div class="carousel-item">
                                                    <img class="img-fluid movil-img" src="{{asset('img/memorygame/edit.png')}}" alt="">
                                                </div>
                                ...
                                <a class="github-logo" href="https://github.com/JResendi2/memorygame">
                                    <div class="d-flex align-items-center gap-1">
                            ...
                            <div class="proyect-footer text-white">
                                <div class="proyect-info">
                                    Aplicación que consiste en encontrar un par de cartas iguales, así hasta encontrar todas las parejas.
                                    <br>
                                </div>
                            </div>
                        </div>
